        ...
        <div class="flex flex-col md:flex-row m-0 mb-2 md:mb-0">
            <div class="w-full">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="genre" name="genre" value="{{ old('genre') }}" class="block w-full text-sm rounded-sm border border-gray-300 p-2 focus:ring focus:ring-blue-400 focus:ring-opacity-50 focus:border-blue-200 focus:outline-none">
                    @error('genre')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
