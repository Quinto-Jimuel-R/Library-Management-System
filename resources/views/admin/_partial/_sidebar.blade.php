<nav class="flex flex-1 flex-col justify-between overflow-hidden">
    ...
    <ul class="space-y-1 overflow-y-auto flex-1 m-2">
        <li>
            <a href="{{ route('admin.dashboard') }}" class="flex flex-row md:flex-col lg:flex-row items-center p-3 md:py-2 lg:p-3 rounded text-sm transition-all duration-100 text-white 
                {{ request()->routeIs('admin.dashboard') ? 'bg-[#0b132b] text-[#3a506b] font-bold' : 'hover:font-bold hover:bg-white hover:text-[#3a506b]'}}">
                <i class="fa-solid fa-signal mr-5 md:mr-0 lg:mr-5 mb-0 md:mb-1 lg:mb-0 w-8 text-center"></i>
                <span class="text-sm md:text-[10px] lg:text-sm">Dashboard</span>
            </a>
        </li>

        <li>
            <a href="{{ route('admin.books') }}" class="flex flex-row md:flex-col lg:flex-row items-center p-3 md:py-2 lg:p-3 rounded text-sm transition-all duration-100 text-white 
                {{ request()->routeIs('admin.books') || request()->routeIs('book.search')  || request()->routeIs('book.create') ? 'bg-[#0b132b] text-[#3a506b] font-bold' : 'hover:font-bold hover:bg-white hover:text-[#3a506b]'}}">
        ...
        <li>
            <a href="{{ route('admin.reports') }}" class="flex flex-row md:flex-col lg:flex-row items-center p-3 md:py-2 lg:p-3 rounded text-sm transition-all duration-100 text-white 
                {{ request()->routeIs('admin.reports') ? 'bg-[#0b132b] text-[#3a506b] font-bold' : 'hover:font-bold hover:bg-white hover:text-[#3a506b]'}}">
                <i class="fa-solid fa-chart-line mr-5 md:mr-0 lg:mr-5 mb-0 md:mb-1 lg:mb-0 w-8 text-center"></i>
                <span class="text-sm md:text-[10px] lg:text-sm">Reports</span>
            </a>
        </li>

        <li>
            <a href="{{ route('admin.users') }}" class="flex flex-row md:flex-col lg:flex-row items-center p-3 md:py-2 lg:p-3 rounded text-sm transition-all duration-100 text-white 
                {{ request()->routeIs('admin.users') || request()->routeIs('user.create') ? 'bg-[#0b132b] text-[#3a506b] font-bold' : 'hover:font-bold hover:bg-white hover:text-[#3a506b]'}}">
                <i class="fa-solid fa-users mr-5 md:mr-0 lg:mr-5 mb-0 md:mb-1 lg:mb-0 w-8 text-center"></i>
                <span class="text-sm md:text-[10px] lg:text-sm">Users</span>
            </a>
        </li>
    </ul>
